// LA PLUPART DES FONCTIONS SONT DES COPIES DE CELLES DANS MULTIJOUEURLOCAL.JS, afin d'y remédier il faudrait que je parvienne à importer un module...
...
function input(elt) {
	...
	// fonction calculant le meilleur coup possible...
	calcCoup();
