...
function reach(piece, c0, c1) {
	switch (piece) {
		case "Roi"      return (abs(c0[0] - c1[0]) in [0, 1]) && (abs(c0[1] - c1[1]) in [0, 1]);
		case "Tour"     return (c0[0] === c1[0]) || (c0[1] === c1[1]);
		case "Fou"      return (abs(c0[0] - c1[0]) === abs(c0[1] - c1[1]));
		case "Reine"    return reach('Tour', c0, c1) || reach('Fou', c0, c1);
		case "Cavalier" return ((abs(c0[0] - c1[0]) === 1) && abs(c0[1] - c1[1]) === 2) || ((abs(c0[0] - c1[0]) === 2) && (abs(c0[1] - c1[1]) === 1));
	}
	return true;
}
...
function win(piece, c0, c1, c2) return (c1 === c2) && reach(piece, c0, c1);
